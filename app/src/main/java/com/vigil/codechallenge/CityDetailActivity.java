...
public class CityDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            int value=getIntent().getIntExtra(CityDetailFragment.ARG_ITEM_POS,-1);

            arguments.putInt(CityDetailFragment.ARG_ITEM_POS,
                    getIntent().getIntExtra(CityDetailFragment.ARG_ITEM_POS,-1));
